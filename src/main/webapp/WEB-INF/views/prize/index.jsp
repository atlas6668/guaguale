...
<body>
    ...
    <ul class="nav nav-tabs">
	    <li class="active"><a data-toggle="tab">奖品花名册</a></li>
	    <!-- <li><a href="<spring:url value='/prize/form'/>" data-toggle="tab">生产奖品</a></li>
	    <li><a href="<spring:url value='/prize/batchform'/>" data-toggle="tab">批量生产</a></li> -->
    </ul>
    
   	<!-- 搜索form -->
    <spring:url value="/prize/index" var="search" />
	...
	&nbsp;<input id="delete-button" class="btn btn-danger" type="button" value="删除奖品"/>
	<!-- 批量删除form -->
    <form id="delete_form" action="<spring:url value='/prize/delete'/>" method="post">
   	...
   	<table class="table table-hover">
		...
		<tbody>
			<c:forEach items="${prizes}" var="prize" varStatus="stat">
				...
				<td>
					<a id="edit" class="btn" href="<spring:url value='/prize/form/${prize.id}'/>">预览</a>
				</td>
			</c:forEach>
		</tbody>
	</table>
