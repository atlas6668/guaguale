...
public class StringUtil {
	 ...
	 * @return
	 */
	public static String subStrRemoveLine(String str, String regex) {
		if(isValid(str)){
			int index = str.indexOf(regex);
			if(index != -1){
				str = str.substring(0, index) + str.substring(index + 1, str.length());
				str =  subStrRemoveLine(str, regex);
			}
		}
		return str;
	}
...
//		System.out.println(StringUtil.isValid(""));
		...
		System.out.println(StringUtil.subStrRemoveLine("2013-01-01", "-"));
	}
}
